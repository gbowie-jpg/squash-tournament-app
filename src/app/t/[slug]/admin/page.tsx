...
import {
  ...
  UserCheck, Mail, Settings, ChevronLeft, Film, ImageIcon, Award, type LucideIcon,
} from 'lucide-react';
...
export default function TournamentAdminDashboard({
  ...
  const links: AdminLink[] = [
    ...
    { href: `/t/${slug}/admin/media`, label: 'Match Media', desc: 'Review and remove photos & videos from match pages', Icon: ImageIcon },
    { href: `/t/${slug}/admin/email`, label: 'Email Marketing', desc: 'Send invitations and updates to participants', Icon: Mail },
    { href: `/t/${slug}/admin/sponsors`, label: 'Sponsors', desc: 'Logos, tiers, splash + footer placement', Icon: Award },
