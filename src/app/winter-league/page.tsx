      ...
      <main className="flex-1 bg-zinc-50">
        <div className="bg-gradient-to-r from-[#1a2332] to-[#2271b1] text-white py-14">
          <div className="max-w-4xl mx-auto px-4">
            <h1 className="text-3xl font-bold text-white">Winter League</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-white rounded-xl border border-zinc-200 p-6 text-center">
              ...
              <p className="text-zinc-600 text-sm mt-2">Season</p>
            </div>
            <div className="bg-white rounded-xl border border-zinc-200 p-6 text-center">
              <p className="text-3xl font-bold text-blue-600">Tuesdays</p>
              <p className="text-zinc-600 text-sm mt-2">Match Night</p>
            </div>
            <div className="bg-white rounded-xl border border-zinc-200 p-6 text-center">
              <p className="text-3xl font-bold text-blue-600">6+ Clubs</p>
              <p className="text-zinc-600 text-sm mt-2">Participating</p>
            </div>
          </div>
