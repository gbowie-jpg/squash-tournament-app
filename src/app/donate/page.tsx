      ...
      <main className="flex-1 bg-surface">
        ...
        <div className="max-w-3xl mx-auto px-4 py-10">
          <div className="bg-card rounded-xl border border-border p-8 mb-8 text-center">
            ...
            <p className="text-foreground leading-relaxed max-w-lg mx-auto mb-6">
            ...
            <p className="text-muted-foreground text-xs mt-3">You&apos;ll be redirected to our secure donation page.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-card rounded-xl border border-border p-5 text-center">
              ...
              <p className="text-muted-foreground text-xs">Coaching, equipment, and court time for young players.</p>
            </div>
            <div className="bg-card rounded-xl border border-border p-5 text-center">
              <span className="text-2xl">🏆</span>
              <h3 className="font-medium mt-2 mb-1">Howe Cup Teams</h3>
              <p className="text-muted-foreground text-xs">Travel and entry fees for national competition.</p>
            </div>
            <div className="bg-card rounded-xl border border-border p-5 text-center">
              <span className="text-2xl">🤝</span>
              <h3 className="font-medium mt-2 mb-1">Community Events</h3>
              <p className="text-muted-foreground text-xs">Tournaments, clinics, and league operations.</p>
            </div>
          </div>
        </div>
      </main>
