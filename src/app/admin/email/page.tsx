          ...
          <div className="bg-card border border-border rounded-xl p-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setExpanded(!expanded)}
                  ...
                  className="hidden md:flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors border border-border rounded-md px-2 py-1">
                  {expanded
            ...
            <div className={expanded ? '' : 'md:grid md:grid-cols-2 md:gap-4'}>
              ...
              <div className={`md:flex md:flex-col ${expanded ? 'md:h-[calc(100vh-320px)]' : 'md:h-[780px]'} ${previewTab === 'preview' ? 'hidden md:flex' : ''}`}>
                ...
                <div className="flex-1 overflow-y-auto rounded-lg border border-border" style={{ background: 'var(--surface)' }}>
